...
const eventPromptJSON = {
    ...
    "emotion": ["happiness", "joy", "anger", "rage", "sadness", "despair", "sorrow", "melancholy", "loss", "lonliness", "betrayal", "friendship", "companionship", "love", "agony", "pain", "disgust", "gratitude", "jealousy", "anxiety", "confusion", "shame", "guilt", "fear", "terror", "admiration", "agitation", "adoration", "hopelessness", "misery", "panic", "bitterness", "frustration", "vengeful", "horror", "delight", "calm", "contentment", "regret", "hatred", "dejection", "dismay", "envy", "fondness", "hope", "isolation", "nostalgia", "powerlessness", "pride", "rejection"],
